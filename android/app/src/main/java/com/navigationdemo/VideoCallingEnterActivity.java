 ...
 *
 * - Direct to the video call view: {@link LaunchActivity}
 */
public class VideoCallingEnterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditInputRoomId.setText("12345678");
    ...
    private void startEnterRoom() {
        ...
        Intent intent = new Intent(VideoCallingEnterActivity.this, LaunchActivity.class);
