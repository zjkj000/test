...
public class BottomButtonActivity extends MainActivity_stu implements View.OnClickListener{
    public static ViewGroup.LayoutParams oldparams;
    public static void qiangDa(MainActivity_stu mainActivity_stu){
