...
public class Set_Highlighter_Fragment_Stu extends Fragment {
    ...
    public Set_Highlighter_Fragment_Stu() {
    }


    public static Set_Highlighter_Fragment_Stu newInstance(String param1, String param2) {
        Set_Highlighter_Fragment_Stu fragment = new Set_Highlighter_Fragment_Stu();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        hihtlightersize1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity_stu.cur_Highlighterpaintsize=100;
        ...
        hihtlightersize2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity_stu.cur_Highlighterpaintsize=150;
        ...
        hihtlightersize3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity_stu.cur_Highlighterpaintsize=200;
        ...
        hihtlightersize4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity_stu.cur_Highlighterpaintsize=250;
        ...
        hihtlightersize5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity_stu.cur_Highlighterpaintsize=350;
        ...
        hihtlightersize6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity_stu.cur_Highlighterpaintsize=450;
