...
class LookCorrectDetailsContent extends Component {
    ...
    PublishAnswer() {
        const url =
            global.constants.baseUrl + "teacherApp_publishZYPaperAnwer.do";
        const params = {
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            if (this.state.data.status == "show") {
                                ...
                                if (
                                    parseInt(this.state.data.noSubmit) /
                                        (parseInt(
                                            this.state.data.noCorrecting
                                        ) +
                                            parseInt(
                                                this.state.data.correcting
                                            )) <
                                    0.2
                                ) {
                                    this.PublishAnswer();
                ...
                <ScrollView style={{ flex: 1 }}>
                    ...
                    >
                        ...
                        {this.state.selectItem == "最高分" ? (
                            ...
                            >
                                {this.state.data.maxList.map(function (
                                    item,
                                    index
                                ) {
                                    return (
                    ...
                    >
                        ...
                        {this.state.selectItem == "最低分" ? (
                            ...
                            >
                                {this.state.data.minList.map(function (
                                    item,
                                    index
                                ) {
                                    return (
                    ...
                    >
                        ...
                        {this.state.selectItem == "已批改" ? (
                            ...
                            >
                                {this.state.data.correctingList.map(function (
                                    item,
                                    index
                                ) {
                                    return (
                    ...
                    >
                        ...
                        {this.state.selectItem == "未批改" ? (
                            ...
                            >
                                {this.state.data.noCorrectingList.map(function (
                                    item,
                                    index
                                ) {
                                    return (
                    ...
                    >
                        ...
                        {this.state.selectItem == "未提交" ? (
                            ...
                            >
                                {this.state.data.noSubmitList.map(function (
                                    item,
                                    index
                                ) {
                                    return (
