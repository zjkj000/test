              ...
              <View style={styles.header}>
                    <Flex style={styles.flexNew}>
                        ...
                        {/*<View style={styles.packagesView} onPress={this.packagesPage}>*/}
                            <TouchableOpacity style={styles.packagesView} onPress={this.packagesPage}>
                                <Image source={require('../../Images/LatestTaskImages/packages.png')}
                                       style={styles.packagesImg}
                                />
                            </TouchableOpacity>
                        {/*</View>*/}
                        <View style={styles.searchView}>
                            <SearchBar placeholder="学案/作业" style={styles.searchBar} />
                        </View>
                        {/*<View style={styles.filterView}>*/}
                        <TouchableOpacity style={styles.filterView} onPress={this.filterList}>
                            <Image source={require('../../Images/LatestTaskImages/filter.png')}
