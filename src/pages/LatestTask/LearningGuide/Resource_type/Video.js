...
class Video_LG extends Component {
    ...
    showContent = () => {
        ...
        if (resource.length <= 0) {
            ...
            return (
                //"http://www.cn901.com/res/91Content/resource/2021/01/22/video/46c31428-3fa2-47d2-ae51-be58a3f8aba0_mp4.mp4"
                                    ...
                                    <Image
                                        ...
                                        source={
                                            this.state.isFullScreen
                                                ? require("../../../../assets/LatestTaskImages/shrink.png")
                                                : require("../../../../assets/LatestTaskImages/full.png")
                                        }
                                    />
                                </TouchableOpacity>
                            </View>
    ...
    render() {
        return (
            <View style={{ backgroundColor: "#FFFFFF" }}>
                ...
                <View style={styles.area}>{this.showContent()}</View>
            </View>
        );
    }
}
