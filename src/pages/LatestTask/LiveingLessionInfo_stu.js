                ...
                <View style={{ flexDirection: "column", width: "90%" }}>
                        ...
                        {this.state.status == "1" ? (
                            <View
                                style={{
                                    position: "absolute",
                                    right: 25,
                                    backgroundColor: "#FF897B",
                                    padding: 5,
                                }}
                            >
                                <Text style={{ color: "#fff" }}>直播中</Text>
                            </View>
                        ) : this.state.status == "2" ? (
                            <View
                                style={{
                    ...
                    <View style={{ flexDirection: "row", marginTop: 10 }}>
                        <Image
                            ...
                            source={require("../../assets/StatisticalForm/clander.png")}
                        />
                        ...
                        <Image
                            style={{ width: 17, height: 17, marginRight: 3 }}
                            source={require("../../assets/StatisticalForm/clock.png")}
                        />
