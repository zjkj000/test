...
export default function LiveingLessionInfo_teacher(props) {
  ...
  <>
    ...
    <View style={{height:50,flexDirection:'row',alignItems:'center',backgroundColor:'#FFFFFF',justifyContent:"center",borderBottomWidth:0.5,borderColor:"#CBCBCB"}}>
                        ...
                        {/* 新建直播课按钮 */}
                        <Image style={{width:20,height:20}} source={require('../../assets/teacherLatestPage/create2.png')} ></Image>
                        </TouchableOpacity>
                  </View>
      ...
      <View style={{flexDirection:'row',paddingLeft:10,paddingBottom:10,paddingTop:10,backgroundColor:'#fff',marginBottom:10}}>
        ...
        <View style={{flexDirection:'column',width:'70%',paddingLeft:10}}>
            ...
            <View style={{flexDirection:'row',justifyItem:'center',alignItems:"center"}}>
                ...
                this.state.subjectName.indexOf('数学')>0?(<Image style={{width:40,height:40}} source={require('../../assets/errorQue/shuxue.png')}/>):
                this.state.subjectName.indexOf('英语')>0?(<Image style={{width:40,height:40}} source={require('../../assets/errorQue/yingyu.png')}/>):
                this.state.subjectName.indexOf('物理')>0?(<Image style={{width:40,height:40}} source={require('../../assets/errorQue/wuli.png')}/>):
                this.state.subjectName.indexOf('化学')>0?(<Image style={{width:40,height:40}} source={require('../../assets/errorQue/huaxue.png')}/>):
                this.state.subjectName.indexOf('政治')>0?(<Image style={{width:40,height:40}} source={require('../../assets/errorQue/zhengzhi.png')}/>):
                this.state.subjectName.indexOf('历史')>0?(<Image style={{width:40,height:40}} source={require('../../assets/errorQue/lishi.png')}/>):
                this.state.subjectName.indexOf('地理')>0?(<Image style={{width:40,height:40}} source={require('../../assets/errorQue/dili.png')}/>):
                (<Image style={{width:40,height:40}} source={require('../../assets/errorQue/other.png')}/>)}
            ...
            <View style={{flexDirection:'row',marginTop:10,alignItems:'center'}}>
                ...
                <Text style={{marginLeft:5,fontSize:10}}>课堂号:</Text>
                <Text style={{fontSize:10}}>{this.state.roomId}</Text>
                <TouchableOpacity onPress={()=>{
                    this.copyToClipboard
                }}>
                    <Image style={{width:10,height:10,marginLeft:3}} source={require('../../assets/teacherLatestPage/tea_copy.png')}/>
                </TouchableOpacity>
         ...
         <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center'}}>
            ...
            // 已结束状态
            this.state.status=='3'?(<>    
                <Text style={{color:'#949494',fontSize:30}}>{this.state.showStrTop}</Text>    
                <Text style={{color:'#949494'}}>{this.state.showStrBottom}</Text>  
            </>):<></>}
        </View>
      </View>
    )
