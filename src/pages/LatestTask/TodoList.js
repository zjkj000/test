...
class TodoList extends React.Component {
            ...
            todos: [
                {
                    statusUrl: "new",
                    status: "1",
                    iconUrl: "../../assets/LatestTaskImages/homework.png",
                    type: "2",
                    createrName: "明茗",
                    bottomTitle: "正弦定理",
                    courseName: "高中数学",
                    ...
                    time: "1月25日",
                    content:
                        "高中数学(北师大版)/必修5/解三角形/正弦定理正弦定理正弦定理",
                    teaScore: null,
                    averageScore: null,
                    rank: null,
                },
                ...
                },
                {
                    statusUrl: "new",
                    status: "1",
                    iconUrl: "../../assets/LatestTaskImages/study.png",
                    type: "1",
                    createrName: "明茗",
                    bottomTitle: "等差数列",
                    courseName: "高中数学",
                    ...
                    time: "1月25日",
                    content:
                        "高中数学(北师大版)/必修5/数列/等差数列/等差等差等差等差等差",
                    teaScore: null,
                    averageScore: null,
                    rank: null,
                },
                {
                    statusUrl: "已读",
                    status: "4",
                    iconUrl: "../../assets/LatestTaskImages/inform.png",
                    type: "3",
                    createrName: "明茗",
                    bottomTitle: "寒假放假通知",
                    courseName: "",
                    ...
                    time: "2022.01",
                    content:
                        "马上就要放寒假了，大家在家注意安全，做好疫情防护工作，提前祝大家新年快乐！",
                    teaScore: null,
                    averageScore: null,
                    rank: null,
                },
                {
                    statusUrl: "未读",
                    status: "5",
                    iconUrl: "../../assets/LatestTaskImages/public-notice.png",
                    type: "4",
                    createrName: "诸珠",
                    bottomTitle: "定时公告2-第3次修改",
                    courseName: "",
                    timeStop: "",
                    time: "2020.04",
                    content: "第二个定时公告2222-第3次次改",
                    teaScore: null,
                    averageScore: null,
                    rank: null,
                },
    ...
    render() {
        ...
        const content = todos.map((todo, index) => {
            ...
            const statusImg =
                todo.statusUrl == "new" || todo.statusUrl == "未读"
