...
export default function AssignPaperContainer(props) {
    const navigation = useNavigation();
    navigation.setOptions({title:'布置作业'});
    console.log('================AssignPaperContainer=======================');
    console.log(props.route.params);
    console.log('==================================================================');
    return <AssignPaper navigation={navigation} paramsData={props.route.params} />;
}

class AssignPaper extends Component {
    constructor(props){
        super(props)
    ...
    SaveAssign(){
        if(this.state.beginstr==''){
            ...
            var allParams = {
                ...
                paperName: this.props.paramsData.paperName,
                paperId: this.props.paramsData.paperId,
                flag: 'save',
            }
            const ip = global.constants.baseUrl;
    ...
    render() {
        ...
        <ScrollView style={{height:'93%',}}>
            ...
            <View style={{flexDirection:'row',paddingLeft:20,alignItems:'center',borderBottomWidth:0.5}}>
                    ...
                    <TextInput value={this.props.paramsData.paperName} placeholder='传过来的值'></TextInput>
            </View>
