                ...
                this.state.isPlaying ? null :
                  <TouchableWithoutFeedback onPress={() => { this.onPressPlayButton() }}>
                    <Image
                      ...
                      source={require('../../../assets/stuImg/MP4.png')}
                    />
              ...
              <View style={[styles.control, {width: this.state.videoWidth}]}>
                <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlPlayPress() }}>
                  <Image
                    ...
                    source={this.state.isPlaying ? require('../../../assets/stuImg/pause-circle-outline.png') : require('../../../assets/stuImg/MP4.png')}
                  />
                </TouchableOpacity>
                ...
                <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlShrinkPress() }}>
                  <Image
                    ...
                    source={this.state.isFullScreen ? require('../../../assets/stuImg/pause-circle-outline.png') : require('../../../assets/stuImg/MP4.png')}
                  />
                </TouchableOpacity>
              </View> : null
          }
