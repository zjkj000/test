...
export default WrongDetails = () => {
    ...
    const handleImg = (sourceType) => {
        switch (sourceType) {
            case "1":
                return (
                    <Image
                        source={require("../../assets/LatestTaskImages/study.png")}
                        style={styles.Img}
                    />
                );
            case "2":
                return (
                    <Image
                        source={require("../../assets/LatestTaskImages/homework.png")}
                        style={styles.Img}
                    />
                );
        }
    ...
    const handleAnswerClass = (basetypeId) => {
        ...
        if (data.baseTypeId == "101" || data.baseTypeId == "102") {
            switch (data.answerNum) {
                case "3":
                    var questionChoiceList = "A,B,C";
                    break;
                case "4":
                    var questionChoiceList = "A,B,C,D";
                    break;
                case "5":
                    var questionChoiceList = "A,B,C,D,E";
                    break;
                case "6":
                    var questionChoiceList = "A,B,C,D,E,F";
                    break;
                case "7":
                    var questionChoiceList = "A,B,C,D,E,F,G";
                    break;
                case "8":
                    var questionChoiceList = "A,B,C,D,E,F,G,H";
                    break;
            }
        }
        ...
        if (basetypeId == "108") {
            ...
            for (
                var read_num_i = 0;
                read_num_i < data.smallQuestionNum;
                read_num_i++
            ) {
                items.push(
    ...
    const showVideo = () => {
        return (
            <View>
                <View style={styles.videoTotle}>
                    <Text> 考点讲解</Text>
                    <Image
                        source={require("../../assets/errorQue/play.png")}
                        style={styles.mp4Img}
                    />
                </View>
                    ...
                    <View style={styles.Bottom}>
                        <View style={styles.Bottom_con}>
                            <View style={styles.Left}>
                                <TouchableOpacity
                                    onPress={() => handleLeft(currentPage)}
                                >
                                    <Image
                            ...
                            <View style={styles.Bottom_text}>
                                <Text style={styles.index}>{currentPage}</Text>
                                <Text>/{allPage}</Text>
                            </View>
                            <View style={styles.Right}>
                                <TouchableOpacity
                                    onPress={() => handleRight(currentPage)}
                                >
                                    <Image
                ...
                <>
                    <ScrollView style={styles.scrollView}>
                        <View style={styles.null}>
                            <Image
                                source={require("../../assets/errorQue/null.png")}
                            />
                        </View>
                    </ScrollView>
                    <View style={styles.Bottom}>
    ...
    const handleErrorList = () => {
        return (
            <>
                <View style={styles.class}>
                    <View style={styles.class_type}>
                        <View style={styles.textAndimg}>
                            ...
                            <Text style={styles.class_type_text}>
                                {" "}
                                {data.sourceName}
                            </Text>
                        </View>
                ...
                {show ? handleAnswerClass(basetypeId) : null}
                {/* 提交答案或查看答案      点击后显示答案*/}
                {show ? (
