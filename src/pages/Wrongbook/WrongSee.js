...
export default WrongSee = () => {
                                ...
                                <View style={styles.class_type}>
                                    <View style={styles.textAndimg}>
                                        ...
                                        <View style={styles.right}>
                                            <Text
                                                style={styles.class_type_text}
                                            >
                                                {" "}
                                                道错题{" "}
                                            </Text>
                                            <Text style={styles.errorQueNum}>
                                                {item.errorQueNum}
                                            </Text>
                                        </View>
                                    </View>
    ...
    //渲染
    return ready == "1" ? handleErrList() : renderLoadingView();
};
