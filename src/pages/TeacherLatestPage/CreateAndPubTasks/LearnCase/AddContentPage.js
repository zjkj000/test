...
class AddContentPage extends React.Component {
    ...
    componentWillUnmount() {
        ...
        console.log(
            "----------add----learnPlanId-----WillUnmount-----",
            this.state.learnPlanId
        );
    ...
    fetchData = (type, typeValue, deviceType) => {
        ...
        console.log(
            "-----fetchData---pageFlag--currentPage--searchPage-",
            pageFlag,
            currentPage,
            searchPage
        );
        ...
        http.get(url, params)
            .then((resStr) => {
                ...
                console.log(
                    "--------导学案内容--length----",
                    resJson.data.esmodelList.length
                );
                ...
                if (
                    ...
                    console.log(
                        "*******firstContentId******resJsonId********",
                        firstContentId,
                        resJson.data.esmodelList[0].id
                    );
                    isFirstPage = true;
                } else {
                    isFirstPage = false;
                        ...
                        this.setState(
                            {
                                ...
                                learnPlanId:
                                    this.props.learnPlanId != ""
                                        ? this.props.learnPlanId
                                        : resJson.data.learnPlanId, //shareTag=99或10才有
                                selectContentIndex: 0,
                                pptList: [],
                                selectPptIndex: 0,
                                showVideoControl: false, // 是否显示视频控制组件
                            ...
                            () => {
                                console.log(
                                    "=======add===props===learnPlanId=============",
                                    this.props.learnPlanId
                                );
                                console.log(
                                    "=======add===state===learnPlanId=============",
                                    this.state.learnPlanId
                                );
                            }
                        );
    ...
    ifSelected = () => {
        const { selectContentIndex, selectContentList, contentList } =
            this.state;
        let i = 0;
            ...
            <View>
                <View style={styles.paperSelectNumView}>
                    <Text style={styles.selectPaperNum}>
                        (已选中{this.state.selectContentNum})
                    </Text>
                    <TouchableOpacity
                        onPress={() => {
                            ...
                            this.setState({
                                imgState: !imgState,
                                selectContentNum: selectContentNum + 1,
                            });
    ...
    showContent = () => {
        ...
        if (contentList[selectContentIndex].type == "paper") {
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{ padding: 10 }}>
                        <RenderHtml
                            ...
                            source={{
                                html: contentList[selectContentIndex].shitiShow,
                            }}
                        ></RenderHtml>
                    </View>
                    ...
                    <View style={{ padding: 10 }}>
                        <RenderHtml
                            contentWidth={screenWidth}
                            source={{
                                html: contentList[selectContentIndex]
                                    .shitiAnswer,
                            }}
                        ></RenderHtml>
                    </View>
            ...
            return (
                <ScrollView showsVerticalScrollIndicator={false}>
                    {contentList[selectContentIndex].format == "ppt" &&
                    this.state.pptList.length <= 0
                        ? this.setState({
                              pptList: contentList[selectContentIndex].pptList,
                          })
                        : null}
                ...
                <View>
                    ...
                    >
                        <Image
                            ...
                            source={{ uri: pptList[selectPptIndex] }}
                        ></Image>
                                ...
                                <Image
                                    ...
                                    source={
                                        this.state.isPlaying
                                            ? require("../../../../assets/LatestTaskImages/continue.png")
                                            : require("../../../../assets/LatestTaskImages/pause.png")
                                    }
                                />
                            </TouchableOpacity>
            ...
            pptItems.push(
                ...
                >
                    <Image
                        ...
                        style={
                            selectPptIndex == ppt_i
                                ? styles.pptchecked
                                : styles.pptlittle_image
                        }
                    />
                </TouchableOpacity>
            );
