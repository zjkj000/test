...
class CreateLearnCase extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            channelNameList:
                this.props.paramsData.actionType == "create"
            ...
            learnPlanId:
                this.props.paramsData.actionType == "create"
                    ? ""
                    : this.props.paramsData.learnPlanId,

            type: "resource",
            typeValue: "",

            addPaperFlag:
                this.props.paramsData.actionType == "create" ? true : false, //导航“添加试题”是否被选中
            updatePaperFlag:
                this.props.paramsData.actionType == "create" ? false : true, //导航“调整顺序”是否被选中
                        ...
                        {this.state.knowledgeList.length > 0 ? (
                            <WebView
                                onMessage={(event) => {
                                    ...
                                    console.log(
                                        JSON.parse(event.nativeEvent.data).name,
                                        JSON.parse(event.nativeEvent.data).id
                                    );
                                    console.log(
                                        "---------------------------------"
                                    );
...
>>>>>>> 168413b3ca8a405caa8e12d049f7a60663bb5011
                    ...
                    >
                        ...
                        {}
                        {this.props.paramsData.createType ==
                        "TeachingPackages" ? (
                            <Text
                                style={
                ...
                {this.state.updatePaperFlag
                    ? console.log("----------", this.state.selectContentNum)
                    : null}
            </View>
        );
    }
