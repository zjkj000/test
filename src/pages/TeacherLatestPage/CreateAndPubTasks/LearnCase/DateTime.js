...
export default class DateTime extends Component {
    ...
    render() {
        return (
            <View >
                <TouchableOpacity style={{ flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', justifyContent: 'center' }}
                    onPress={() => { this._showDatePicker() }}>
                    <Image style={{ width: 30, height: 30 }} source={require('../../../../assets/teacherLatestPage/time.png')}></Image>
                </TouchableOpacity>
            </View>
