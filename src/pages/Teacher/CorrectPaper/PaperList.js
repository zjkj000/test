...
export default function PaperList(props) {
    ...
    function renderAvatarAll(){
      return (
        ...
        >
            <Image style={{width:30,height:30}} source={require('../../../assets/teacherLatestPage/set.png')}/>
        </TouchableOpacity>
    );
    }
    ...
    function renderAvatarCorrect(){
      return (
        ...
        >
           <Image style={{width:30,height:30}} source={require('../../../assets/teacherLatestPage/search.png')}/>
        </TouchableOpacity>
    );
    }
        ...
        <View style={{backgroundColor:'#FFFFFF',height:"100%",flexDirection:'column'}}>
          <View style={{height:60,flexDirection:'row',alignItems:'center',borderBottomWidth:0.5,borderColor:'#CBCBCB'}}>
              ...
              <View style={{width:'62%'}}>
                <SearchBar
                                  ...
                                  onCancel={()=>
                                    {
                                      setdata([])
                                      fetchData(isRefreshing=false,statusa=status)
                                    }
                                  }
              ...
              <OverflowMenu
                       ...
                       <MenuItem title={'只显示需要手工批阅试题'}  key={1}
                                 onPress={() => {
        ...
        return(
          <TouchableOpacity onPress={()=>{
              ...
              <View style={{borderBottomColor:'#000000',borderBottomWidth:0.5,flexDirection:'row',height:80,padding:15}}>
                <View >
                    <Image style={{height:50,width:50,borderRadius:25}} source={{uri:this.state.userPhoto}} ></Image>
                </View>
                ...
                <View style={{paddingLeft:15,width:'90%',justifyContent:'center'}}>
                    <View style={{flexDirection:'row',marginBottom:8}}>
                        ...
                        (<View style={{flexDirection:'row',width:'25%'}}>
                          ...
                          <View style={{flexDirection:'row',width:'25%'}}>
                              <Text style={{color:'#008000'}}>未批改</Text>
                              <Image style={{width:17,height:17,marginLeft:5}} source={require('../../../assets/teacherLatestPage/noCheck.png')}></Image>
                          </View>
                        ):<Text></Text>}

                        <Text style={{width:'25%'}}>{this.state.description}</Text>
