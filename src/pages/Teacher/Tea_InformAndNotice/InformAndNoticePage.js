...
import { Avatar, OverflowMenu, MenuItem } from "@ui-kitten/components";
    ...
    showFilter = () => {
        return (
            <View>
                ...
                >
                    <MenuItem title="全部" onPress={this.handleAll} />
                    <MenuItem title="通知" onPress={this.handleInform} />
                    <MenuItem title="公告" onPress={this.handleNotice} />
                </OverflowMenu>
            </View>
        );
    };
